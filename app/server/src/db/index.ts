...
const SCHEMA = `
  ...
  CREATE TABLE IF NOT EXISTS display_settings (
    ...
    use_us_premarket_pnl    INTEGER NOT NULL DEFAULT 0,
    use_us_postmarket_pnl   INTEGER NOT NULL DEFAULT 0,
...
async function migrate(): Promise<void> {
  ...
  const addColumns: Array<[string, string]> = [
    ...
    ["display_settings", "use_us_premarket_pnl INTEGER NOT NULL DEFAULT 0"],
    ["display_settings", "use_us_postmarket_pnl INTEGER NOT NULL DEFAULT 0"],
